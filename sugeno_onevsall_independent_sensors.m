...
for i = 1:4
    [onevsall_ind{i}.sugeno, onevsall_ind{i}.fis_input] = ...
        perform_sugeno(onevsall_ind{i}.best_sensor, i, features_ds);
end

function [sugeno, input] = perform_sugeno(sensor, act, features_ds)
